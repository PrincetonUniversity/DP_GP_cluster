...
class gibbs_sampler():
    ...
    '''
    def __init__(self, gene_expression_matrix, gene_names, max_num_iterations, burnIn_phaseI, burnIn_phaseII, s, check_convergence):
        self.iter_num = 0
    ...
    def sampler(self, gene_expression_matrix, gene_names, max_num_iterations, burnIn_phaseI, burnIn_phaseII, s, check_convergence):
